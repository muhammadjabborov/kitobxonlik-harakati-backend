...
KITOBXONLIK_HARAKATI_CONFIG = {
    "base_url": env.str("MUTOLAA_BASE_URL", ""),
    "username": env.str("KITOBXONLIK_HARAKATI_USERNAME", ""),
    "password": env.str("KITOBXONLIK_HARAKATI_PASSWORD", ""),
    "timeout": env.int("MUTOLAA_API_TIMEOUT", 30),
}
